...
> <a href="/documentation/saturn-data/index.html#/notation/format-specifications/sat_latest">SAT Format Specification</a>

## Options
A list of options in the top right corner for how the Chart data should be displayed.

#### Show Whitespace
Determines if the text editor should show bullet points `•` to visualize whitespace more clearly.

#### Syntax Highlighting
Determines if the text editor should apply syntax highlighting to the chart data.

## Apply Changes
Attempts to apply changes made to the Chart data.
