...
- Setup
  ...
  - [Audio Setup](setup/audio.md)
  - [Chart Setup](setup/chart.md)
...
- Editors
  ...
  - [Stage Editor](editors/stage_editor.md)
  - [Cosmetic Editor](editors/cosmetic_editor.md)

- Tool Windows
  - [Chart View (3D)](tool-windows/chart_view_3d.md)
  - [Chart View (Text)](tool-windows/chart_view_text.md)
  - [Chart Properties](tool-windows/chart_properties.md)
  - [Chart Statistics](tool-windows/chart_statistics.md)
  - [Proofreader](tool-windows/proofreader.md)
  - [Event List](tool-windows/event_list.md)
  - [Layer List](tool-windows/layer_list.md)
