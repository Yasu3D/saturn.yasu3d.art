...
> Tip: If a property has this button <img src="media/automate.png" width="20"> next to it, it can be automated!  
...
> If you don't know what that means, refer to this page:  
...
The **first option** to align the audio and beat grid is to use external software.
1. Open the audio file in the audio editor of your choice.
